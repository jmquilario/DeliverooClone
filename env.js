 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.deliverooclone.staging
 */

const BUNDLE_ID = 'com.deliverooclone'; // ios bundle id
const PACKAGE = 'com.deliverooclone'; // android package name
const NAME = 'DeliverooClone'; // app name
